...
class LSHDataContainer:
    ...
    def __post_init__(self):
        ...
        if len(self.config.static_features) != n_static:
            raise ValueError(
                f"Config has {len(self.config.static_features)} static features, but static_attributes has {n_static}"
            )
